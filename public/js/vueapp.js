...
/* harmony import */ var _Auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Auth */ "./resources/js/components/Auth.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  extends: _Auth__WEBPACK_IMPORTED_MODULE_0__["default"],
  data: function data() {
    return {};
  }
});
...
/***/ "./resources/js/axios_keycloak.js":
/*!****************************************!*\
  !*** ./resources/js/axios_keycloak.js ***!
  \****************************************/
/*! exports provided: default */
...
var axios_keycloak = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create();
var keycloak = Keycloak();
keycloak.init({
  onLoad: 'login-required'
}).success(function (authenticated) {
  sessionStorage.setItem('token', keycloak.token);
  axios_keycloak.get('user').then(function (response) {
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].commit('setUser', response.data);
  });
  setInterval(function () {
...
axios_keycloak.interceptors.response.use(function (response) {
  return response;
}, function (error) {
  // token expired
...
/* harmony default export */ __webpack_exports__["default"] = (axios_keycloak);
...
}, // Not found
{
  path: '/unauthorized',
  name: 'Unauthorized',
  component: _components_Unauthorized__WEBPACK_IMPORTED_MODULE_4__["default"]
}];
...
/* harmony import */ var _axios_keycloak__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./axios_keycloak */ "./resources/js/axios_keycloak.js");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$axios = _axios_keycloak__WEBPACK_IMPORTED_MODULE_2__["default"];
...
__webpack_require__(/*! D:\projetos\sso_spa_sessionstorage\resources\js\vueapp.js */"./resources/js/vueapp.js");
module.exports = __webpack_require__(/*! D:\projetos\sso_spa_sessionstorage\resources\sass\app.scss */"./resources/sass/app.scss");
